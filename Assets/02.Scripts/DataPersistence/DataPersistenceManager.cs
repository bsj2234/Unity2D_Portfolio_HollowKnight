...
public class DataPersistenceManager : MonoBehaviour
{
    ...
    public void DeleteProfileData(string profileId)
    {
        ...
        InitializeSelectedProfileId();
        //reload the game so that our data matchs the newly selected profile id
        LoadGame();
    }
    ...
    public void LoadGame()
    {
        ...
        this._gameData = dataHandler.Load(selectedProfileId);
        ...
        //if no datat can be loaded , don't continus
