...
public class FileDataHandler : MonoBehaviour
{
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        // use Path.Combine to account for different Os's having differnet path separators
        ...
        if(File.Exists(fullPath))
        {
            try
            {
                ...
                //optinally decrypt the data
                if(useEncryption)
                {
                    dataToLoad = EncryptDecrypt(dataToLoad);
                }
                // deseruakuze tge data from Jons back into the c# object
            ...
            catch(Exception e)
            {
                ...
                // which without his check may cause an infinite recursion loop.
                ...
                // if we hit ehis else block, one possibility is that the backup file is also corrupt
                else
                {
                    Debug.LogWarning("Error occured when truing to load file at path: " 
    ...
    public void Save(GameData data, string profileId)
    {
        ...
        try
        {
            ...
            // wirte the serialized data to the file
